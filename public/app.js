...
async function validateAndSubmitOrder(e) {
    ...
    try {
        ...
        if (isSuccess) {
            ...
            // Сохраняем данные на сервер (включая новый заказ, адреса и обновленные бонусы)
            ...
            try {
                ...
                console.warn('⚠️ Ошибка или таймаут при сохранении данных:', saveError);
            ...
            try {
                ...
                console.warn('⚠️ Ошибка или таймаут при загрузке данных:', loadError);
                // Продолжаем выполнение даже при ошибке загрузки
            }
